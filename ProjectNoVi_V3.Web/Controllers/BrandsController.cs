...
namespace ProjectNoVi_V3.Web.Controllers
{
    ...
    public class BrandsController : Controller
    {
        ...
        public BrandsController(ProjectNoVi_V3_Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,MerkName")] Brand brand)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MerkName")] Brand brand)
        {
            if (id != brand.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProjectNoVi_V3_Context.Brand'  is null.");
            }
            var brand = await _context.Brand.FindAsync(id);
            if (brand != null)
            {
